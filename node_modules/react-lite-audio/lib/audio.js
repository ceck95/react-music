(function() {
  ...
  module.exports = React.createClass({
    ...
    render: function() {
      var className, classNameIcon, duration, durationFormat, playPercent, progressStyle, src, timelineStyle;
      src = this.props.source;
      duration = this.state.duration;
      durationFormat = this.formatDuration(duration);
      playPercent = this.state.currentTime / this.state.duration * 100;
      className = cx('audio-player', {
        'is-playing': !this.state.pause
      });
      ...
      timelineStyle = {
        width: duration / 60 * 100 + 100
      };
      progressStyle = {
        width: playPercent + "%"
      };
      return div({
        className: 'lite-audio'
      }, div({
        className: className,
        style: timelineStyle,
