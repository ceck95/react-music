(function() {
  var App, LiteAudio, LiteAudioSlim, PageApp, React, ReactDOM, div;
  ...
  App = React.createClass({
    ...
    render: function() {
      ...
      return div(null, div({
        className: 'wrapper'
      }, div(null, 'LiteAudio: audio palyer with progress-bar'), LiteAudio({
        source: source,
        isUnread: true
      })), div({
        className: 'wrapper'
      }, div(null, 'LiteAudioSlim: audio palyer with progress-tip'), LiteAudioSlim({
        source: source,
        isUnread: true
      })));
    }
